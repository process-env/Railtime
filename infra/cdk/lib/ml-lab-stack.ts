      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            { name: 'num_on_time_trips', type: 'bigint' },
            { name: 'num_sched_trips', type: 'bigint' },
            { name: 'terminal_on_time_performance', type: 'double' },
          ],
        },
      },
    });
      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            { name: 'fare_evasion_pct', type: 'double' },
            { name: 'margin_of_error', type: 'double' },
          ],
        },
      },
    });
      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            { name: 'total_miles', type: 'bigint' },
            { name: 'number_of_failures', type: 'bigint' },
            { name: 'number_of_cars', type: 'bigint' },
            { name: 'mdbf', type: 'double' },
            { name: 'twelve_month_avg_mdbf', type: 'double' },
          ],
        },
      },
    });
      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            { name: 'num_passengers', type: 'double' },
            { name: 'additional_platform_time', type: 'double' },
            { name: 'additional_train_time', type: 'double' },
            { name: 'total_apt', type: 'double' },
            { name: 'total_att', type: 'double' },
            { name: 'over_five_mins', type: 'double' },
            { name: 'over_five_mins_pct', type: 'double' },
            { name: 'customer_journey_time_performance', type: 'double' },
          ],
        },
      },
    });
      ...
      tableInput: {
        ...
        storageDescriptor: {
          ...
          columns: [
            ...
            { name: 'line', type: 'string' },
            { name: 'day_type', type: 'string' },
            { name: 'num_sched_trains', type: 'bigint' },
            { name: 'num_actual_trains', type: 'bigint' },
            { name: 'service_delivered_pct', type: 'double' },
          ],
        },
      },
    });
          ...
          onStart: [
            {
              content: cdk.Fn.base64(
                [
                  ...
                  'echo "Setting auto-stop to 3600 seconds"',
